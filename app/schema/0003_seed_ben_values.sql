...
INSERT OR REPLACE INTO profile_values (user_id, field_key, value_json, updated_at) VALUES ('user_ben', 'st_workExperiences', '[{"title": "Operations & Data Analyst", "employer": "Closing Day", "startDate": "2026-01", "endDate": null, "city": "Apollo Beach, FL", "description": "Sales pipeline analytics platform. Designed the relational data model and the scoring logic that ranks client records on past performance."}, {"title": "Operations & Data Analyst", "employer": "The South Shore Team", "startDate": "2016-01", "endDate": null, "city": "Apollo Beach, FL", "description": "Residential real estate sales team, $36 million in annual transaction volume. Reconcile CRM, MLS, transaction management, and bookkeeping into one set of numbers."}]', '2026-07-28T00:00:00Z');
